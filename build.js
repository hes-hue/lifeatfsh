...
function generateSubpageHtml(key, profile) {
  ...
  subpage = subpage.replace('href="src/styles.css?v=1.0.8"', 'href="/src/styles.css?v=1.0.8"');
  subpage = subpage.replace('src="src/data.js?v=1.0.8"', 'src="/src/data.js?v=1.0.8"');
  subpage = subpage.replace('src="src/main.js?v=1.0.8"', 'src="/src/main.js?v=1.0.8"');
  ...
  <script src="/src/main.js?v=1.0.8"></script>`;
  subpage = subpage.replace('<script src="/src/main.js?v=1.0.8"></script>', scriptInsertion);
