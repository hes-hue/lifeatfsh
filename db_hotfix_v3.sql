-- ========================================================
-- HOTFIX: Fix Twibbon download + admin update issues
-- Run this in Supabase SQL Editor
-- ========================================================

-- 1. Drop ALL old overloads of execute_secure_write to eliminate ambiguity
-- Drop the old parameter-order variant (if it exists)
...
-- 2. Recreate the canonical function with clean signature
